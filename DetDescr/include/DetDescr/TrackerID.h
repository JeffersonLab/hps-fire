...
namespace ldmx {
    ...
    /**
     * @class TrackerID
     * @brief Extension of DetectorID providing access to layer and module number for tracker IDs
     */
	...
	/** Create from values
	 */
	TrackerID(SubdetectorIDType system, unsigned int layer, unsigned int module) : DetectorID(system,0) {
